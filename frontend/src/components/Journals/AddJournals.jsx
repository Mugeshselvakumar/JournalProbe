...
const AddJournals = () => {
  ...
  const fetchOldData = async () => {
    ...
    try {
      ...
      setCountry(data.data.message.country);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!title || !description||!country  || !journalContent || !author) {
  ...
  return (
    <div className='p-4 '>
      <div className='flex items-center flex-col'><br></br>
        <div className='text-4xl p-4 text-green-700'>Showcase Your Journals</div>
        <div className='flex flex-col gap-y-[2rem] w-[80%] mt-[1rem] items-center bg-white '><br></br>
          <div className='relative w-full sm:w-[70%]'>
            ...
            />
            <label className="absolute left-0 -top-4 text-gray-500 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-green-700 peer-focus:text-sm">Title</label>
          </div>
          <div className='relative w-full sm:w-[70%]'>
            ...
            />
            <label className="absolute left-0 -top-4 text-gray-500 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 peer-focus:-top-5 peer-focus:text-green-700 peer-focus:text-sm">Description</label>
          </div>

          <div className="relative w-full sm:w-[70%]">
           <select
             className="peer h-10 border-solid w-full border-b-2 border-gray-800 text-black bg-transparent placeholder-transparent focus:outline-none focus:border-gray-800 "
             value={country}
              name="country"
             ...
             <label className="absolute left-0 -top-4 text-gray-500 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 peer-focus:-top-5 peer-focus:text-green-700 peer-focus:text-sm">
              Country
             </label>
          </div>
          ...
          <div className='w-full sm:w-[70%] flex flex-col items-start gap-4 text-lg m-2'>
            <div className='flex justify-between w-full items-center text-white'>
              <button onClick={handleGenerate} className='flex items-center gap-x-[0.5rem] bg-green-700 p-[0.5rem] rounded-md '>
          ...
          <div className='flex w-full sm:w-[70%] flex-col sm:flex-row'>
            <div className='relative w-full sm:w-[50%] flex flex-col items-start gap-4 text-lg m-2'>
              ...
              />
              <label className="absolute left-0 -top-4 text-gray-500 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-green-700 peer-focus:text-sm">Author</label>
            </div>
            <div
          ...
          <button className='bg-green-700 px-3 py-3 rounded-lg mt-7 text-2xl shadow-xl text-white' onClick={handleSubmit}>Add Post</button>
          <br></br>
        </div>
      </div>
      <ToastContainer />
