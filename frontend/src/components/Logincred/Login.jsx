...
const LoginForm = () => {
    ...
    return (    
        <div className="w-full flex flex-col justify-center md:w-1/2 bg-gradient-to-r rounded-lb-xl shadow-2xl overflow-hidden p-10 space-y-8 rounded-l-xl">
            ...
            <div className="text-center text-gray-900"> Don't have an account?
                <button className="text-green-700 px-2 hover:underline" onClick={toSignup}>Sign up</button>
            </div>
            <ToastContainer />
        </div>
    );
